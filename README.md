...
| **Day 14** | Sept 14, 2026 | Text/Time Semantics & Quincy's Job Tips Workshop | Completed theory on `<blockquote>`, `<q>`, `<abbr>`, `<address>`, `<time>`, and Quincy's Job Tips workshop | [Read Log](./logs/day-14.md) |
